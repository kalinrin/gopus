...
// Link against the prebuilt static Opus library (opus 1.6.1).
//
// Layout expected inside this module:
//   gopus/opus/include/opus.h , opus_defines.h , opus_types.h , ...
//   gopus/opus/lib/libopus.a
//
// ${SRCDIR} expands to the directory of this source file, so the paths
// stay valid no matter where the module is checked out.

/*
#cgo CFLAGS: -I${SRCDIR}/opus/include
#cgo LDFLAGS: -L${SRCDIR}/opus/lib -lopus -lm
